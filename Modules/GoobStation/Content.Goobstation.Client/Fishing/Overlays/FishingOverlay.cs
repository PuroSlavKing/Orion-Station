...
public sealed class FishingOverlay : Overlay
{
    ...
    public FishingOverlay(IEntityManager entManager, IPlayerManager player)
    {
        ...
        var sprite = new SpriteSpecifier.Rsi(new ResPath("/Textures/Interface/Misc/fish_bar.rsi"), "icon");
    ...
    /// </summary>
    private Color GetProgressColor(float progress, float alpha = 1f)
    {
