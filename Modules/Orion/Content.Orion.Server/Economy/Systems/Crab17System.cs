...
using System.Linq;
using Content.Orion.Server.Economy.Components;
using Content.Orion.Shared.Economy.Components;
using Content.Orion.Server.Mood;
...
using Content.Orion.Shared.Economy;
...
namespace Content.Orion.Server.Economy.Systems;

public sealed partial class Crab17System : EntitySystem
{
    ...
    [Dependency] private SharedPopupSystem _sharedPopup = default!;
