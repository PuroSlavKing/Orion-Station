...
public enum DestructiveAnalyzerUiKey : byte { Key }
[Serializable, NetSerializable]
public enum ExperimentalDestructiveScannerUiKey : byte { Key }
[Serializable, NetSerializable]
public enum ExperiScannerUiKey : byte { Key }
...
public sealed class DestructiveAnalyzerSelectMethodMessage : BoundUserInterfaceMessage
{
    ...
    public DestructiveAnalyzerSelectMethodMessage(string methodId) => MethodId = methodId;
}
...
public sealed class DestructiveAnalyzerBoundInterfaceState : BoundUserInterfaceState
{
    ...
    public DestructiveAnalyzerBoundInterfaceState(string? connectedServerName, List<ResearchPointAmount> pointBalances, string lastSubject, string lastResult, string? insertedItem, NetEntity? insertedItemEntity, string? selectedMethod, List<string> methods)
    {
...
public sealed class ExperimentalDestructiveScannerBoundInterfaceState : BoundUserInterfaceState
{
    ...
    public ExperimentalDestructiveScannerBoundInterfaceState(string? connectedServerName, List<ResearchPointAmount> pointBalances, string lastSubject, string lastResult, List<ResearchMachineExperimentUiData> experiments, string? insertedItem)
    {
        ConnectedServerName = connectedServerName;
        PointBalances = pointBalances;
        LastSubject = lastSubject;
...
public sealed class ExperiScannerBoundInterfaceState : BoundUserInterfaceState
{
    ...
    public ExperiScannerBoundInterfaceState(string? connectedServerName, List<ResearchMachineExperimentUiData> experiments, string lastResult)
    {
        ConnectedServerName = connectedServerName;
        Experiments = experiments;
        LastResult = lastResult;
